...
def connect(
    ...
    # message = (
    #     f"foobar_worker mode!! {mode} {mode == SCRIPT_MODE}"
    #     f"job_config._runtime_env_has_working_dir() {job_config._runtime_env_has_working_dir()} "
    #     f"interactive_mode {interactive_mode}"
    #     f"job_config._client_job {job_config._client_job} "
    #     f"script_directory {os.path.dirname(os.path.realpath(driver_name))}"
    #     f"current_directory {os.path.abspath(os.path.curdir)}"
    #     f"job_config._py_driver_sys_path {job_config._py_driver_sys_path} "
    # )
    # raise Exception(message)
    logger.error(f"foobar_worker mode!! {mode}")
    logger.error(f"foobar_worker job_config._runtime_env_has_working_dir()!!! {job_config._runtime_env_has_working_dir()}")
    logger.error(f"foobar_worker interactive_mode!!! {interactive_mode}")
    logger.error(f"foobar_worker job_config._client_job!!! {job_config._client_job}")
    logger.error(f"foobar_worker script_directory!!! {os.path.dirname(os.path.realpath(driver_name))}")
    logger.error(f"foobar_worker current_directory!!! {os.path.abspath(os.path.curdir)}")
    ...
    logger.error(f"foobar_worker after if statement!! {job_config._py_driver_sys_path}")
