...
serve start \
 --grpc-port 9000 \
 --grpc-servicer-functions proto.user_defined_protos_pb2_grpc.add_UserDefinedServiceServicer_to_server \
 --grpc-servicer-functions proto.user_defined_protos_pb2_grpc.add_ImageClassificationServiceServicer_to_server

serve run b.deployment:g
"""
