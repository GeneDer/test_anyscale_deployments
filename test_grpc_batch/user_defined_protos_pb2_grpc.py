...
class UserDefinedServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.__call__2 = channel.unary_unary(
                '/userdefinedprotos.UserDefinedService/__call__2',
                request_serializer=user__defined__protos__pb2.Request.SerializeToString,
                response_deserializer=user__defined__protos__pb2.Responses.FromString,
                )
...
class UserDefinedServiceServicer(object):
    ...
    def __call__2(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_UserDefinedServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            '__call__2': grpc.unary_unary_rpc_method_handler(
                    servicer.__call__2,
                    request_deserializer=user__defined__protos__pb2.Request.FromString,
                    response_serializer=user__defined__protos__pb2.Responses.SerializeToString,
            ),
    }
...
class UserDefinedService(object):
    ...
    def __call__2(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/userdefinedprotos.UserDefinedService/__call__2',
            user__defined__protos__pb2.Request.SerializeToString,
            user__defined__protos__pb2.Responses.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
